<template>
    <div class="border">
        ...
        <div class="border">
            ...
            <!-- <el-button type="primary" round @click="onSubmit">发布第一次时间</el-button> -->
        </div>
        <div class="border"> 
            ...
            start-placeholder="开始日期"
             ...
             <!-- <el-button type="primary" round @click="onSubmit">发布第二次时间</el-button> -->
        </div>
        <div class="border">
...
export default {
  ...
  methods: {
    test () {
      console.log(this.firstTime[0])
    },
    onSubmit () {
      const self = this
      console.log(self.secondTime[0] || '空')
      axios.post('/date/uploadTime', {
        year: self.theYear,
        firstStartDate: self.firstTime[0] || '',
        firstEndDate: self.firstTime[1] || '',
        secondStartDate: self.secondTime[0] || '',
        secondEndDate: self.secondTime[1] || ''
      })
       .then(response => {
