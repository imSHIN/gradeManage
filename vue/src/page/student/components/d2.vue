<template>
    <div>
            ...
            <el-form  label-position='left' label-width="230px">
                <!-- <el-form-item label="学年每周公寓检查结果平均分: ">
                 ...
                 <el-form-item label="文明寝室-获奖: ">
                  <el-radio-group v-model="domi.dormitoryRadio">
        ...
        <div class="border">
            <p class="h2">履行责任、服务奉献记实分（满分8分）</p> 
            <el-form  label-position='left' label-width="230px">
        ...
        <div class="border">
            ...
            <div class="border">
              <el-button type="primary" round @click="addPraise">添加通报表扬(校级）</el-button>
  <!-- 添加通报表扬 -->
