  ...
  <section>
    ...
    <el-dialog title="学生信息" :visible.sync="dialogFormVisible">
      <el-form :model="form">
        ...
        <el-form-item label="职位" :label-width="formLabelWidth">
          <el-input v-model="form.jzxPosition" auto-complete="off"></el-input>
        </el-form-item>
        <el-form-item label="电话" :label-width="formLabelWidth">
          <el-input v-model="form.jzxTel" auto-complete="off"></el-input>
        </el-form-item>
      </el-form>
    ...
    <el-dialog title="学生信息" :visible.sync="dialogAddVisible">
      <el-form :model="add" >
        ...
        <el-form-item label="职位" :label-width="formLabelWidth">
          <el-input v-model="add.jzxPosition" auto-complete="off"></el-input>
        </el-form-item>
        <el-form-item label="电话" :label-width="formLabelWidth">
          <el-input v-model="add.jzxTel" auto-complete="off"></el-input>
        </el-form-item>
      </el-form>
      <div slot="footer" class="dialog-footer">
  ...
  export default {
    methods: {
      ...
      dialogAdd () {
        ...
        params.append('jzxPosition', this.add.jzxPosition)
        params.append('jzxTel', this.add.jzxTel)
        axios.post('/teacher/insert', params)
          .then(response => {
      ...
      handleDelete (index, rowInfo) {
        ...
        params.append('id', rowInfo.jzxId)
          axios.post('/teacher/delete/',params)
            .then(response => {
              if (response.status !== 200 && response.data !== 1) {
              this.$alert( '错误', {
                confirmButtonText: '确定'
      ...
      dialogUpdate () {
        ...
        params.append('jzxPosition', this.form.jzxPosition)
        params.append('jzxTel', this.form.jzxTel)
        axios.post('/teacher/update/', params)
          .then(response => {
            if (response.status !== 200 && response.data !== 1) {
              this.$alert( '错误', {
                confirmButtonText: '确定'
